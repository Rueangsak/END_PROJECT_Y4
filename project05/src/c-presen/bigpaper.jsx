...
/** Editor canvas — shows live results when answerUser is provided from parent. */
export default function Bigpaper({ filter, indexFilterShow, answerUser = [] }) {
  if (!filter?.length) {
    return <SlideCanvas emptyMessage="No slides yet — add one with New slide" />;
  }
