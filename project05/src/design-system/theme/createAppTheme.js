import createThemeModule from '@mui/material/styles/createTheme';

const createTheme =
  typeof createThemeModule === 'function'
    ? createThemeModule
    : createThemeModule?.default;
...
export function createAppTheme(mode = 'light') {
  if (typeof createTheme !== 'function') {
    throw new Error(
      'MUI createTheme failed to load. Delete node_modules/.vite and restart npm run dev.'
    );
  }
